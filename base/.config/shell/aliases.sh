...
alias ....='cd ../../..'
alias .....='cd ../../../..'
alias cdot='cd ~/git_repos/capndot && printf " \U000F17A9 " && pwd'
alias brain='cd ~/git_repos/My-Brain && printf " \U000F17A9 " && pwd'
alias aliases='nvim ~/git_repos/capndot/base/shell/aliases'
alias cd="zd"
zd() {
  if [ $# -eq 0 ]; then
    builtin cd ~ && return
